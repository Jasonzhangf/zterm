...
export const SUBSCRIBER_PENDING_RANGE_LIMIT = 64;
export const SUBSCRIBER_PENDING_SPAN_LINE_LIMIT = TERMINAL_BUFFER_SYNC_FRAME_MAX_SPAN_LINES;
export const SUBSCRIBER_PENDING_AGE_LIMIT_MS = 15_000;
