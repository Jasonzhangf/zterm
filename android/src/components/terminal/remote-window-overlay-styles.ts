...
export const styles: Record<string, CSSProperties> = {
  ...
  lockedControlStrip: {
    ...
    overflowX: 'auto',
    overflowY: 'hidden',
    padding: '0 max(10px, env(safe-area-inset-right, 0px)) max(6px, env(safe-area-inset-bottom, 0px)) max(10px, env(safe-area-inset-left, 0px))',
    WebkitOverflowScrolling: 'touch',
    scrollbarWidth: 'none',
  ...
  compactStatusLine: {
    ...
    alignItems: 'center',
    gap: 8,
    padding: '0 max(10px, env(safe-area-inset-right, 0px)) 4px max(10px, env(safe-area-inset-left, 0px))',
    color: 'var(--zterm-panel-muted)',
    fontSize: 11,
    lineHeight: 1.3,
  },
