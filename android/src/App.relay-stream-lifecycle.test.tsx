...
vi.mock('./contexts/SessionContext', async () => {
  ...
  return {
    ...
    useSession: () => ({
      ...
      setActiveBodySubscriptionSuppressed: vi.fn(),
      ...
      requestRemoteWindowStreamStart: vi.fn(),
      updateRemoteWindowStreamQuality: vi.fn(),
      stopRemoteWindowStream: vi.fn(),
      sendRemoteWindowInput: vi.fn(),
      resizeRemoteWindowTarget: vi.fn(),
      sendMessageRaw: vi.fn(),
      manageTmuxSessionsOnOpenTransport: vi.fn(),
      onFileTransferMessage: vi.fn(),
      onRemoteWindowMessage: vi.fn(),
