    ...
    if (this.state.error) {
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('p', { style: { margin: 0, lineHeight: 1.5, color: '#9b9da5' } }, '请重新加载应用。错误详情已记录。'),
          React.createElement(
            'button',
            {
              type: 'button',
              onClick: () => window.location.reload(),
              style: { minHeight: '44px', border: 0, borderRadius: '8px', background: '#38d47d', color: '#07110b', fontWeight: 700 },
            },
            '重新加载',
          ),
        ),
