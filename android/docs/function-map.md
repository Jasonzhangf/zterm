...
| `terminal.session_group_layout` | `src/lib/terminal-layout-profile.ts`; `src/pages/TerminalPageStageShell.tsx` | app-layer layout/projection framework for existing session pane containers; Phase 1 keeps phone baseline, Phase 2 changes layout modes, Phase 3 adds cross-screen projection/virtualization | `terminal-layout-profile.test.ts`; `TerminalPageStageShell.pane-stage.test.tsx`; `useTerminalWorkspace.test.tsx`; `docs/testing/terminal-session-group-layout-test-design.md` |
