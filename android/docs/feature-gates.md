...
- `settings.config_transfer`: prove Settings export/import returns explicit success/error results with a user-visible path or error message; console-only success or silent boolean return is not enough.
