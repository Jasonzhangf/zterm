...
- `windows.desktop_shell` session discovery/create/close UI is implemented and has packaged Windows L5 marker proof.

## Next

1. Extract platform-neutral desktop workspace/pane composition from Mac without copying `window.ztermMac` IPC.
2. Add a Windows filesystem/browser adapter and packaged installer after the workspace boundary is shared.
