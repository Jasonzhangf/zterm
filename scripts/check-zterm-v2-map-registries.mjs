...
if ([resourceRegistry, moduleRegistry, featureRegistry, functionMap, mainlineMap, verificationMap, phaseManifest].every(Boolean)) {
  ...
  const roots = ['android/native/android/app/src/main', 'android/src', 'mac/electron', 'mac/src', 'win/electron', 'win/src', 'packages/shared/src', 'packages/runtime-contracts/src', 'packages/ui-contract/src', 'packages/kernel/src', 'packages/stream-boundary/src', 'packages/desktop-gateway/src', 'packages/ios-host/src'];
