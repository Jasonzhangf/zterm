...
export interface ScreenshotHelperLaunchAgentPlistOptions {
  label: string;
  launchRunner: string;
  stdoutPath: string;
  stderrPath: string;
...
export function buildScreenshotHelperLaunchAgentPlistXml(options: ScreenshotHelperLaunchAgentPlistOptions) {
