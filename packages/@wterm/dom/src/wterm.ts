...
export class WTerm {
  ...
  private _doRender(): void {
    ...
    const shouldStickToBottom = this._shouldScrollToBottom;
    ...
    if (shouldStickToBottom) {
      ...
      const scrollHeightDelta = this.element.scrollHeight - previousScrollHeight;
      if (scrollHeightDelta !== 0 && previousScrollTop > 0) {
        this.element.scrollTop = Math.max(0, previousScrollTop + scrollHeightDelta);
      }
    }
