    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: '21px', fontWeight: 800, color: mobileTheme.colors.lightText }}>
              {mode === 'quick-tab' ? 'Quick New Tab' : 'New Connection'}
            </div>
        ...
        >
          ...
          {selectedCount > 0 && (
            <button
              onClick={() => onOpenMultipleTmuxSessions(selectedTarget, selectedSessions)}
              style={{
                minHeight: '48px',
                border: 'none',
                borderRadius: '16px',
        ...
        >
          ...
          >
            {mode === 'quick-tab' ? 'Create blank tab target' : 'Open full connection form'}
          </button>
