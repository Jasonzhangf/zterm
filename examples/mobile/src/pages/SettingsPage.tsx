    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '18px 18px 32px' }}>
        ...
        <div style={sectionStyle()}>
          ...
          <div style={{ color: mobileTheme.colors.lightMuted, lineHeight: 1.6 }}>
            Server entry:
            <br />- `pnpm --filter @wterm/mobile daemon start|status|stop|restart`
            <br />- `examples/mobile/scripts/wterm-mobile-daemon.sh`
            <br />- auth token / host / port come from `{WTERM_CONFIG_DISPLAY_PATH}`
            <br />- optional env override: `WTERM_MOBILE_AUTH_TOKEN=... pnpm --filter @wterm/mobile daemon start`
          </div>
